                                        ...
                                        <tr>
                                            <td valign="top" style="padding-top: 5px;">
                                                <table style="width: 80%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        <td style="text-align: left" class="formItemBgStyle">welder_no：
                                                        </td>
                                                        <td style="text-align: left" class="formItemBgStyle">
                                                            <asp:TextBox ID="TXT_Welder_no" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td style="text-align: left" class="formItemBgStyle">WPSNo：
                                                        </td>
                                                        <td style="text-align: left" class="formItemBgStyle">
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left" class="formItemBgStyle">remarks：
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: center" class="formItemBgStyle" colspan="4">
                                                            ...
                                                            <input type="button" value="返回" id="BT_Return" class="inpu" onclick="window.location.href = 'TTGDWelderWPSNoList.aspx'" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
