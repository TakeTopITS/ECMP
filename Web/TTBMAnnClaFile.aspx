                                            ...
                                            <td align="center" class="formItemBgStyle">
                                                ...
                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="1px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%--          <asp:BoundColumn DataField="ReplyContent" HeaderText="供应商">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" align="left" class="formItemBgStyle">
                                        ...
                                        <asp:DropDownList ID="DL_Type" runat="server">
                                            <asp:ListItem Value="澄清文件" Text="<%$ Resources:lang,ChengQingWenJian%>" />
                                            <asp:ListItem Value="答疑文件" Text="<%$ Resources:lang,DaYiWenJian%>" />
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
