...
(function() {
    ...
    var bi = function(b) {
        if (a.vml) {
            ...
            h.title = "TakeTopSoft Colour Picker";
    ...
    bF = function(a) {
        return function() {
            throw new Error("TakeTopSoft: you are calling to method “" + a + "” of removed object")
        }
    };
    a.pathToRelative = bp;
    if (a.svg) {
        ...
        a[H] = function() {
            return "Your browser supports SVG.\nYou are running TakeTopSoft " + this.version
        };
        var bH = function(a, b) {
            var c = bG("path");
        ...
        k.clear = function() {
            ...
            this.bottom = this.top = null; (this.desc = bG("desc"))[l](g.createTextNode("Created with TakeTopSoft"));
            a[l](this.desc);
