                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="formItemBgStyle" style="text-align: left">
                                                            <asp:DropDownList ID="ddl_TrainingType" runat="server">
                                                                ...
                                                                <asp:ListItem Value="员工培训" Text="<%$ Resources:lang,YuanGongPeiXun%>" />
                                                                <asp:ListItem Value="培训记录" Text="<%$ Resources:lang,PeiXunJiLu%>" />
                                                                <asp:ListItem Value="特种作业" Text="<%$ Resources:lang,TeZhongZuoYe%>" />
                                                                <asp:ListItem Value="特种设备" Text="<%$ Resources:lang,TeZhongSheBei%>" />
                                                                <asp:ListItem Value="焊接持证" Text="<%$ Resources:lang,HanJieTeZheng%>" />
                                                                <asp:ListItem Value="施工管理员证" Text="<%$ Resources:lang,SiGongGuanLiYuanZheng%>" />
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td class="formItemBgStyle" style="text-align: right">
