                                ...
                                <tr style="color: #000000">
                                    ...
                                    <td align="left" class="formItemBgStyle" style="height: 30px">
                                        <asp:DropDownList ID="DL_DiseaseType" runat="server" CssClass="shuru">
                                            <asp:ListItem Value="尘肺" Text="<%$ Resources:lang,ChenFei%>" />
                                            <asp:ListItem Value="放射病" Text="<%$ Resources:lang,FangSheBing%>" />
                                            <asp:ListItem Value="中毒" Text="<%$ Resources:lang,ZhongDu%>" />
                                            <asp:ListItem Value="物理因素" Text="<%$ Resources:lang,WuLiYinSu%>" />
                                            <asp:ListItem Value="生物因素" Text="<%$ Resources:lang,ShengWuYinSu%>" />
                                            <asp:ListItem Value="皮肤病" Text="<%$ Resources:lang,PiFuBing%>" />
                                            <asp:ListItem Value="眼病" Text="<%$ Resources:lang,YanBing%>" />
                                            <asp:ListItem Value="耳鼻喉疾病" Text="<%$ Resources:lang,ErBiHouJiBing%>" />
                                            <asp:ListItem Value="肿瘤" Text="<%$ Resources:lang,ZhongLiu%>" />
