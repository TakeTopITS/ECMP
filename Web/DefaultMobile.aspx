...
OnBlur="javascript:if(this.value==''){this.value='请输入你的登录帐号(UserCode)';this.style.color='gray'}" ForeColor="#000000" class="dengl" Width="103%"></asp:TextBox>--%>

                            <asp:TextBox ID="TB_UserCode" runat="server" Text="请输入你的登录帐号(UserCode)" onFocus="javascript:this.value='';document.getElementById('LB_ErrorMsg').style.display = 'none';" ForeColor="#000000" class="dengl" Width="103%"></asp:TextBox>
...
OnBlur="javascript:if(this.value==''){this.value='请输入密码(Password)';this.style.color='gray'}"  ForeColor="#000000" class="dengl" Width="103%"></asp:TextBox>--%>
