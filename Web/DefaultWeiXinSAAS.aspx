                ...
                <ContentTemplate>
                    <div id="AboveDiv">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center">
                                    <asp:TextBox ID="TB_CompanyName" runat="server" Text="请输入你的公司名称(CompanyName)" onFocus="javascript:if(this.value =='请输入你的公司名称(CompanyName)'){ this.value='';};document.getElementById('LB_ErrorMsg').style.display = 'none';" ForeColor="#000000" class="dengl" Width="103%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="center">
                                    <asp:TextBox ID="TB_UserCode" runat="server" Text="请输入你的登录帐号(UserCode)" onFocus="javascript:if(this.value =='请输入你的登录帐号(UserCode)'){ this.value='';};document.getElementById('LB_ErrorMsg').style.display = 'none';" ForeColor="#000000" class="dengl" Width="103%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: right;">&nbsp;</td>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    ...
                                    <asp:Button ID="BT_Login" runat="server" CssClass="inpuLogon" Text="登录(Login)" OnClientClick="RemmberUserNameAndPassord()"
