        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="layout">
                    ...
                    <label class="nav" for="home" onclick="JavaScript:parent.detailPMFrame.location.href='TTUndertakeProjectSAAS.aspx'">
                        <span>
                    ...
                    <label class="nav" for="about" onclick="JavaScript:parent.detailPMFrame.location.href='TTInvolvedProjectSAAS.aspx'">
                        <span>
                            <svg viewbox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                                <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                                <polyline points="9 22 9 12 15 12 15 22"></polyline>
                    ...
                    <label class="nav" for="contact" onclick="JavaScript:parent.detailPMFrame.location.href='TTCreatedProjectSAAS.aspx'">
                        <span>
                            <svg viewbox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                                <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                                <polyline points="9 22 9 12 15 12 15 22"></polyline>
