namespace ProjectMgt.Model
{
    ...
    /// 预算数据更改前历史记录
    /// </summary>
    public class BDBaseDataRecord
    {
        public BDBaseDataRecord()
        {
        }
        ...
        private int bDBaseDataID;

        public virtual int BDBaseDataID
        {
            get { return bDBaseDataID; }
            set { bDBaseDataID = value; }
        }
