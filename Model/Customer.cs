...
namespace ProjectMgt.Model
{
    public class Customer
    {
        ...
        private string customerEnlishName;
        private string type;
        ...
        private string belongAgencyCode;
        ...
        public virtual string CustomerEnglishName
        {
            get { return customerEnlishName; }
            set { customerEnlishName = value; }
        }
        ...
        public virtual string BelongAgencyCode
        {
            get; set;
        }

        public virtual string BelongAgencyName
        {
            get; set;
        }
        ...
        public virtual string WorkSiteURL
        {
            get; set;
        }
    }
